...
class Model_Finder:
    ...
    def get_best_model(self, train_x, train_y, test_x, test_y,cls):
        ...
        try:
            ...
            self.score.all_score(test_y,self.prediction_xgb_class,cls,title="XGB Testing Score")
            self.prediction_xgb_class_train = self.xgb_class.predict(train_x)
            self.score.all_score(train_y, self.prediction_xgb_class_train,cls, title="XGB Training Score")
            ...
            self.score.all_score(test_y,self.prediction_lgb_class,cls,title="LGB Testing Score")
            self.prediction_lgb_class_train = self.lgb_class.predict(train_x)
            self.score.all_score(train_y, self.prediction_lgb_class_train,cls, title="LGB Training Score")
            ...
            self.score.all_score(test_y,self.prediction_cb_class,cls,title="Catboost Testing Score")
            self.prediction_cb_class_train = self.cb_class.predict(train_x)
            self.score.all_score(train_y, self.prediction_cb_class_train,cls, title="Catboost Training Score")
