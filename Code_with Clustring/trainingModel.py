    ...
    def trainingModel(self):
        ...
        try:
            ...
            for i in list_of_clusters:
                ...
                cluster_features,cluster_label=preprocessor.handleImbalanceDataset(cluster_features,cluster_label)
                # splitting the data into training and test set for each cluster one by one
                x_train, x_test, y_train, y_test = train_test_split(cluster_features, cluster_label, test_size=1 / 5, random_state=355)
